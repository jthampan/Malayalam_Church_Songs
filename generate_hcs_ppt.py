#!/usr/bin/env python3
"""
Church Songs PPT Generator
===========================
Searches for songs by hymn number in PDFs and existing PPT files, then generates
...
Usage:
    python3 generate_hcs_ppt.py --batch songs.txt "Output Name.pptx"
...
HYMNS_PPT = os.path.join(BASE_DIR, "Hymns_malayalam_KK.pptx")
...
SEARCH_DIRS = [
    os.path.join(BASE_DIR, "OneDrive_2026-02-05"),
    BASE_DIR,
]
...
def find_best_song_source(hymn_num, song_name, language="Malayalam"):
    """
    Search all PPT files and find the best source for a song.
    ...
    Args:
        ...
        language: "Malayalam" or "English" to search in specific folders
    
    Returns: (pptx_path, title_idx, content_indices, extracted_title) or (None, None, [], "")
    """
    pptx_files = find_all_pptx_files(SEARCH_DIRS, language)
...
def process_opening_song(prs, title_layout, blank_layout, hymn_num, song_name, slide_counter, language="Malayalam"):
    """Process Opening Song section."""
    label = "Opening"
    
    # Find the best source (most slides) across all PPT files
    best_pf, t_idx, c_indices, extracted_title = find_best_song_source(hymn_num, song_name, language)
...
def process_thanksgiving_prayers(prs, title_layout, blank_layout, hymn_num, song_name, slide_counter, language="Malayalam"):
...
def process_offertory(prs, title_layout, blank_layout, hymn_num, song_name, slide_counter, language="Malayalam"):
...
def process_confession(prs, title_layout, blank_layout, hymn_num, song_name, slide_counter, language="Malayalam"):
...
def process_holy_communion(prs, title_layout, blank_layout, hymn_num, song_name, slide_counter, language="Malayalam"):
...
def process_closing_hymn(prs, title_layout, blank_layout, hymn_num, song_name, slide_counter, language="Malayalam"):
...
def process_generic_song(prs, title_layout, blank_layout, label, hymn_num, song_name, slide_counter, language="Malayalam"):
...
def generate_presentation(song_list, output_filename=None, language="Malayalam", service_date=None):
    """
    ...
    language: str ("Malayalam" or "English") - determines which PPT folders to search
    ...
    for song_info in song_list:
        ...
        if label_lower == "opening":
            slide_counter, extracted_title = process_opening_song(prs, title_layout, blank_layout, hymn_num, title_hint, slide_counter, language)
            if extracted_title:
                song_info["title_hint"] = extracted_title
        elif label_lower in ("thanksgiving", "thanksgiving prayers", "b/a"):
            slide_counter, extracted_title = process_thanksgiving_prayers(prs, title_layout, blank_layout, hymn_num, title_hint, slide_counter, language)
            if extracted_title:
                song_info["title_hint"] = extracted_title
        elif label_lower == "offertory":
            slide_counter, extracted_title = process_offertory(prs, title_layout, blank_layout, hymn_num, title_hint, slide_counter, language)
            if extracted_title:
                song_info["title_hint"] = extracted_title
        elif label_lower == "message":
            slide_counter = process_message(prs, title_layout, slide_counter)
        elif label_lower == "confession":
            slide_counter, extracted_title = process_confession(prs, title_layout, blank_layout, hymn_num, title_hint, slide_counter, language)
            if extracted_title:
                song_info["title_hint"] = extracted_title
        elif label_lower in ("communion", "holy communion"):
            slide_counter, extracted_title = process_holy_communion(prs, title_layout, blank_layout, hymn_num, title_hint, slide_counter, language)
            if extracted_title:
                song_info["title_hint"] = extracted_title
        elif label_lower == "closing":
            slide_counter, extracted_title = process_closing_hymn(prs, title_layout, blank_layout, hymn_num, title_hint, slide_counter, language)
            if extracted_title:
                song_info["title_hint"] = extracted_title
        elif label_lower == "dedication":
            slide_counter, extracted_title = process_generic_song(prs, title_layout, blank_layout, "Dedication", hymn_num, title_hint, slide_counter, language)
            if extracted_title:
                song_info["title_hint"] = extracted_title
        else:
            slide_counter, extracted_title = process_generic_song(prs, title_layout, blank_layout, label, hymn_num, title_hint, slide_counter, language)
            if extracted_title:
                song_info["title_hint"] = extracted_title
...
def main():
    ...
    if 'service_date' in locals():
        ...
        generate_presentation(songs, output_name, language)
